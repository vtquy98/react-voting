      ...
      *******************************/
      ...
      appendHTML: function() {
        ...
        if (
          ...
          $(
            "<div class='nbs-flexisel-nav-left'><i class='material-icons'>chevron_left</i></div><div class='nbs-flexisel-nav-right'><i class='material-icons'>chevron_right</i></div>"
      ...
      offsetItemsToBeginning: function(number) {
        ...
        for (var i = 0; i < number; i++) {
          object
            .children()
            .last()
            .insertBefore(object.children().first());
        }
      },
      ...
      offsetItemsToEnd: function(number) {
        ...
        for (var i = 0; i < number; i++) {
          object
            .children()
            .first()
            .insertAfter(object.children().last());
        }
      },
